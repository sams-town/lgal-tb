...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['tambah_tenaga_medis'])) {
    ...
    try {
        ...
        $_SESSION['success_msg'] = "Data Tenaga Medis berhasil ditambahkan";
...
// Get data
try {
    $stmt = $pdo->prepare("SELECT * FROM tenaga_medis WHERE tipe_form = 'tambah-tenaga-medis' ORDER BY created_at DESC");
    $stmt->execute();
...
<head>
    ...
    <title>Tambah Tenaga Medis - RS Taman Harapan Baru</title>
...
<body class="min-h-screen bg-gray-50 flex">
        ...
        <div class="flex-1 p-8 overflow-y-auto">
            <div class="space-y-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Tambah Tenaga Medis</h1>
                        <p class="text-gray-600 mt-2">Form tambah tenaga medis baru</p>
                    </div>
                ...
                <div class="flex items-center gap-3 mb-4">
                    <a href="export_handler.php?action=export_data&module=tenaga_medis&subpage=tambah-tenaga-medis" class="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2 rounded-xl font-medium hover:bg-emerald-700 transition-colors">
                        📊
    ...
    <div id="importModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4">
            ...
            <form method="POST" action="export_handler.php?action=import_data&module=tenaga_medis&subpage=tambah-tenaga-medis" enctype="multipart/form-data" class="p-6 space-y-4">
                <div>
