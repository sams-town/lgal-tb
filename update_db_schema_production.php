...
try {
    ...
    $newCols = [
        ...
        'file_str' => "VARCHAR(255) NULL AFTER no_str",
        'no_sip' => "VARCHAR(255) NULL AFTER file_str",
        'formatting_sip_mulai' => "DATE NULL AFTER no_sip", // Gunakan nama temporary jika kolom spesifik dibutuhkan
        ...
        'file_pks' => "VARCHAR(255) NULL AFTER masa_berlaku_pks_mulai",
