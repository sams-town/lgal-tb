...
// Handle form submission for editing Komite Medik
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_tenaga_medis'])) {
    if (!canUserEditOrDelete('komite')) {
        ...
        try {
            ...
            $_SESSION['success_msg'] = "Data Komite Medik berhasil diperbarui";
        } catch (PDOException $e) {
    ...
    <div id="modal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div class="p-6 border-b border-gray-100 flex items-center justify-between">
                <h2 id="modal_title" class="text-xl font-bold text-gray-900">Form Tambah Tenaga Medis - Komite Medik</h2>
            ...
            <form method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2 pt-2">
                        <!-- Rincian Kewenangan Klinis dipindah ke Dokumen Legalitas sebagai RKK -->
                    </div>
                </div>
                <div class="space-y-4">
                    <h3 class="text-lg font-semibold text-gray-800 border-b pb-2">Dokumen Legalitas</h3>                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- STR -->
    ...
    <script>
        ...
        window.openModal = function(modalId) {
            if (modalId === 'modal' || !modalId) {
                ...
                document.getElementById('modal_title').textContent = 'Form Tambah Tenaga Medis - Komite Medik';
            }
        ...
        function resetForm() {
            ...
            document.getElementById('status_karyawan_medik').value = 'Tetap';
        ...
        function openEditModal(doc) {
            ...
            document.getElementById('spesialis').value = doc.spesialis || '';
            document.getElementById('status_karyawan_medik').value = doc.status_kepegawaian || 'Tetap';
            if (doc.status_kepegawaian === 'Tetap') {
                ...
                document.getElementById('container_sk_medik').classList.add('hidden');
                document.getElementById('container_pkwt_medik').classList.remove('hidden');
            }
            ...
            document.getElementById('kompetensi_klinis') && (document.getElementById('kompetensi_klinis').value = ''); // field dihapus, skip
            // Handle sertifikasi - field sudah dihapus dari form
            // Tidak perlu populate
            ...
            document.getElementById('modal_title').textContent = 'Edit Komite Medik';
